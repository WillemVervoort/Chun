...
require(httr)
require(tidyverse)
# MOD44B Chun's project (annual data)
# FTP server
FTP <- "https://e4ftl01.cr.usgs.gov/MOLT/MOD44B.006/"
...
for(i in 1:length(WDIR2)){
  ...
  # specification of the path to MRT is important
	MRTproj(fname="tmp.prm",WDIR2[i],
	 ...
	 UL="", LR="", resample_type="NEAREST_NEIGHBOR", proj_type="UTM",
	 utm_zone = 55,
